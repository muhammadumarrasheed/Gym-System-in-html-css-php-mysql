...
<head>
    ...
    <title>Trainer Payment Panel</title>
</head>
<style>
* {
...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Trainer Payement</label>
        <button type="addUser" class="addUserbtn"><a href="trainerPaymentDataIn.php" class="text-light">Add
                Payment</a></button>
        <table class="table" style="width:50%">
            ...
            <tbody>
                <?php
                $sql = "select * from trainerpayment";
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $date = $row['date'];
                        echo '<tr>
                        <th scope="row">'.$trainerEmail.'</th>
                        <td>'.$status.'</td>
                        <td>'.$date.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="trainerPaymentDataUpd.php?updname='.$trainerEmail.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="trainerPaymentDataDel.php?delname='.$trainerEmail.'"class = "text-light">Delete</a></button><br>
