...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Trainer Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="trainerDataIn.php" class="text-light"><i
                    class="fa-solid fa-user-plus" style="font-size:30px;color:white;"></i>Add Trainer</a></button>
        <table class="table" style="width:50%">
            ...
            <tbody>
                <?php
                $sql = "select traineremail,trainername,password,phoneNum,postacode,city,streetID,houseNum from trainer where traineremail != 'none@gmail.com'"; //trainer data query
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$house.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="trainerDataUpd.php?updateid='.$email.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="trainerDataDel.php?deleteid='.$email.'"class = "text-light">Delete</a></button><br>
                 </td>
                    </tr>';
                    }
                }
