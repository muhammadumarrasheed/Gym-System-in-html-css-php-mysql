...
<body>
    ...
    <div class="container">
        <label class="titl">Users' Plan Information</label>
        <button type="addUser" class="addUserbtn"><a href="userPlanAdded.php" class="text-light">Add
                users' plan</a></button>
        <table class="table" style="width:50%">
            ...
            <tbody>
                <?php
                $sql = "SELECT user.userEmail,user.name,planname from (user join plan on user.userEmail = plan.userEmail) where user.trainerEmail = '$var'";
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$plan.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="usersPlanUpdate.php?updateid='.$email.'" class = "text-light">Update</a></button><br>
                 </td>
                    </tr>';
                    }
                }
