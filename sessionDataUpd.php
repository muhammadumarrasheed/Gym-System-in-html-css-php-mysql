...
include 'dbconn.php';
$id = $_GET['updateid'];
$sql = "select * from `session` where sessionid = '$id'";
...
$name = $_POST['name'];
$sql = "update `session` set sessionid = '$id',sessionname = '$name' where sessionid = '$id'";
$result = mysqli_query($con, $sql);
if($result){
header("Location: sessionData.php");
}else{
header("Location:  sessionData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">Session update Form</label>
            </div>
            <div class="form-group">
