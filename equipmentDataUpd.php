...
$name = $_POST['name'];
$sql = "update `equipment` set id = '$id',name = '$name' where id = '$id'";
$result = mysqli_query($con, $sql);
if($result){
header("Location: equipmentData.php");
}else{
header("Location:  equipmentData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">Equipment update Form</label>
            </div>
            <div class="form-group">
