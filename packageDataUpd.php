...
$name = $_POST['name'];
$sql = "update `package` set packageid = '$id',packagename = '$name' where packageid = '$id'";
$result = mysqli_query($con, $sql);
if($result){
header("Location: packageData.php");
}else{
header("Location:  packageData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">Package update Form</label>
            </div>
            <div class="form-group">
