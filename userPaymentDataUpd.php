...
$sql = "select * from `userpayment` where userEmail = '$userEmail'";
...
$status = $_POST['status'];
$date = $_POST['date'];
$sql = "update `userpayment` set userEmail = '$userEmail',status = '$status', date = '$date' where userEmail = '$userEmail'";
$result = mysqli_query($con, $sql);
if($result){
        header("Location: userPaymentData.php");
}else{
header("Location:  userPaymentData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title>User Payment update Panel</title>
</head>
<style>
* {
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">User Payment update Form</label>
            </div>
            <div class="form-group">
