...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Equipment Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="equipmentDataIn.php" class="text-light"><i
                    class="fa-solid fa-user-plus" style="font-size:30px;color:white;"></i>Add Equipment</a></button>
        <table class="table" style="width:50%">
            ...
            <tbody>
                <?php
                $sql = "select * from equipment"; // equipments get from db
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$name.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="equipmentDataUpd.php?updateid='.$id.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="equipmentDataDel.php?deleteid='.$id.'"class = "text-light">Delete</a></button><br>
