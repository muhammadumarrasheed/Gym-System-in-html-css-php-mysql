...
<head>
    ...
    <title>User Payment Panel</title>
</head>
<style>
* {
...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage User Payement</label>
        <button type="addUser" class="addUserbtn"><a href="userPaymentDataIn.php" class="text-light">Add user
                Payment</a></button>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$date.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="userPaymentDataUpd.php?updname='.$userEmail.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="userPaymentDataDel.php?delname='.$userEmail.'"class = "text-light">Delete</a></button><br>
