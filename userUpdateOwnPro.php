...
$sql = "update `user` set userEmail = '$email',name = '$name',password = '$password',phoneNum = '$phone',postacode = '$postal',city = '$city',streetID = '$street',houseNum = '$house',sessionid = '$sessionid', packageid = '$packageid', classid = '$classid',trainerEmail = '$trainerEmail' where userEmail = '$email'";
$result = mysqli_query($con, $sql);
if($result){
header("Location: userPanel.php");
}else{
header("Location:  userPanel.php?error = Data is not updated");
}
}?>
