...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage plan Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="planDataIn.php" class="text-light"><i
                    class="fa-solid fa-user-plus" style="font-size:30px;color:white;"></i>Add plan</a></button>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$name.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="planDataUpd.php?updname='.$userEmail.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="planDataDel.php?delname='.$userEmail.'"class = "text-light">Delete</a></button><br>
