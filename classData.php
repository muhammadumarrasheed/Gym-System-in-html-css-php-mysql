...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Class Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="classDataIn.php" class="text-light"><i
                    class="fa-solid fa-user-plus" style="font-size:30px;color:white;"></i>Add new Class</a></button>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$name.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="classDataUpd.php?updateid='.$id.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="classDataDel.php?deleteid='.$id.'"class = "text-light">Delete</a></button><br>
