...
include 'dbconn.php';
$email = $_GET['updateid'];
$sql = "select * from `trainer` where traineremail = '$email'";
...
postacode = '$postal',city = '$city',streetID = '$street',houseNum = '$house' where traineremail = '$email'"; //trainer update
$result = mysqli_query($con, $sql);
if($result){
header("Location: trainerData.php");
}else{
header("Location:  trainerData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">Trainer update Form</label>
            </div>
            <div class="form-group">
