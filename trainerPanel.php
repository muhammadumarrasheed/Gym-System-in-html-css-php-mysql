...
<body>
    ...
    <div class="container">
        <label class="titl">Profile Information</label>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$house.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="trainerProfileUpdate.php?updateid='.$email.'" class = "text-light">Update</a></button><br>
                 </td>
                    </tr>';
                    }
                }
