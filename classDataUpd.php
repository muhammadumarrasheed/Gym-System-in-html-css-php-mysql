...
$name = $_POST['name'];
$sql = "update `class` set classid = '$id',classname = '$name' where classid = '$id'";
$result = mysqli_query($con, $sql);
if($result){
header("Location: classData.php");
}else{
header("Location:  classData.php?error = Data is not updated");
}
}?>
<!doctype html>
<html lang="en">
    ...
    <div class="container my-5">
        <form method="post">
            <div class="form-group">
                <label class="title">class update Form</label>
            </div>
            <div class="form-group">
