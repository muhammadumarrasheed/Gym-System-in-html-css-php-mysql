...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Package Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="packageDataIn.php" class="text-light">Add new
                Package</a></button>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <td>'.$name.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="packageDataUpd.php?updateid='.$id.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="packageDataDel.php?deleteid='.$id.'"class = "text-light">Delete</a></button><br>
