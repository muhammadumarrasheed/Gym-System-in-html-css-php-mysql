...
<body>
    ...
    <div class="container">
        <label class="titl"> Manage Fitness Dasboard</label>
        <button type="addUser" class="addUserbtn"><a href="fitnessDataIn.php" class="text-light">Add
                fitness</a></button>
            ...
            <tbody>
                ...
                if($result){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        $status = $row['fitnessstatus'];
                        echo '<tr>
                        <th scope="row">'.$userEmail.'</th>
                        <td>'.$status.'</td>
                        <td>
                     <button class = "btn btn-primary my-1"><a href="fitnessDataUpd.php?updname='.$userEmail.'" class = "text-light">Update</a></button><br>
                     <button class = "btn btn-danger my-1"><a href="fitnessDataDel.php?delname='.$userEmail.'"class = "text-light">Delete</a></button><br>
